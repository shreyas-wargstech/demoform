...
// Derived helper: map stepNumber -> stepId (single source of truth)
export const STEP_ID_BY_NUMBER: Record<number, string> = Object.values(
  NOC_STEP_CONFIG,
).reduce(
  (acc, s) => {
...
export const PERMREGFormSlice = createSlice({
  name: "PERMREGForm",
  initialState,
  reducers: {
    ...
    builder
      ...
      .addCase(startNOCForm.fulfilled, (state, action) => {
        ...
        if (action.payload.isExisting && action.payload.nextStep) {
          ...
          state.stepId = STEP_ID_BY_NUMBER[nextStepNum] || "overview";
        }
      })
...
export const {
  ...
  clearNOCError,
  resetNOCForm,
} = PERMREGFormSlice.actions;

// Selectors
export const selectPERMREGFormState = (state: RootState) => state.PERMREGForm;
export const selectPERMREGCurrentStep = (state: RootState) =>
  state.PERMREGForm.stepId;
export const selectPERMREGSubmitSuccess = (state: RootState) =>
  state.PERMREGForm.submitSuccess;
export const selectPERMREGDocuments = (state: RootState) =>
  state.PERMREGForm.documents;
export const selectPERMREGPayment = (state: RootState) =>
  state.PERMREGForm.payment;
export const selectPERMREGFormId = (state: RootState) =>
  state.PERMREGForm.formId;
export const selectPERMREGLoading = (state: RootState) =>
  state.PERMREGForm.loading;
export const selectPERMREGError = (state: RootState) => state.PERMREGForm.error;
export const selectPERMREGFinalConsent = (state: RootState) =>
  state.PERMREGForm.finalConsent;
export const selectPERMREGSubmittedSteps = (state: RootState) =>
  state.PERMREGForm.submittedSteps;
export const selectPERMREGNewRegistrationFormId = (state: RootState) =>
  state.PERMREGForm.newRegistrationFormId;
...
export default PERMREGFormSlice.reducer;
