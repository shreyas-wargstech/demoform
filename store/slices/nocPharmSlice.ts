...
export interface NOCPharmFormState {
  formId: string;
...
const initialState: NOCPharmFormState = {
  formId: "",
  practitionerId: "",
...
// Derived helper: map stepNumber -> stepId
...
export const NOCPharmFormSlice = createSlice({
  name: "NOCPharmForm",
  initialState,
  reducers: {
...
export default NOCPharmFormSlice.reducer;
